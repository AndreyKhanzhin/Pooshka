...
if (double.TryParse(x, out double x0) == false || double.TryParse(y, out double y0) == false || double.TryParse(V, out double V0) == false || double.TryParse(a, out double aint) == false || V0 < 0 || y0 < 0){
